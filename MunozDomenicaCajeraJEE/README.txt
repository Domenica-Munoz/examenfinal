...
a persistence unit "MunozDomenicaCajeraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "MunozDomenicaCajeraJEE\pom.xml":
...
artifact ("MunozDomenicaCajeraJEE.war") is already built. You can build
