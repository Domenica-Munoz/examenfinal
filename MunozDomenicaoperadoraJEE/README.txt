...
a persistence unit "MunozDomenicaoperadoraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "MunozDomenicaoperadoraJEE\pom.xml":
...
artifact ("MunozDomenicaoperadoraJEE.war") is already built. You can build
